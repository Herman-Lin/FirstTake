...
<?php
      ...
      function setNote( $Note ) {
        global $connection;
        $query = "INSERT INTO notes (Judge, Video, Note) VALUES (\"{$_GET['usr']}\",15,\"{$Note}\")";
        $result = mysqli_query($connection , $query);
      }

      function getAllNotes() {
        global $connection;
        $query = "SELECT Note FROM notes WHERE Video = 15 && Judge = \"{$_GET['usr']}\"";
        $result = mysqli_query($connection, $query);
      ...
      if ($_POST['formName'] != "score") {
        ...
        header("Location: /thanks.php?usr={$_GET['usr']}");
      ...
      <div id="container">
        <div id="header">
          ...
          <h1 align=right><br><br>Dustin Rios - "Work Flow"</h1>
        </div>
      </div>
      ...
      <body style="background-color:#232f64;">
        <div>
          <div style="float: left; width: 50%">
            ...
            <source src="vid/F.mp4" type="video/mp4">
            </video>
            <br>
            <br>
      ';
